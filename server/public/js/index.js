...
}
{
    ...
    var arr = Array.of(4, 3, 7, 9, 11);
    console.log('arr=', arr);

    var empty = Array.of(); // 空数组
...

{
    ...
    try {
        for (var _iterator4 = [1, 'c', 'ks'].entries()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
