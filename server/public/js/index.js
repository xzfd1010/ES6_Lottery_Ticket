...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(90), __webpack_require__(124)(module)))
    ...
    _createClass(Timer, [{
        ...
        value: function countdown(end, update, handle) {
            ...
            if (now - end) {
                ...
                if (r.length || h > 0) {
                    //判断数组长度是为了判断是否有天，只有有"天"的时候才继续添加小时
                    r.push('<em>' + h + '</em>\u65F6');
                }
                if (r.length || m > 0) {
                    r.push('<em>' + s + '</em>\u5206');
...
var Calculate = function () {
    ...
    _createClass(Calculate, [{
        ...
        value: function computeBonus(active, play_name) {
            var play = play_name.split(''); // 当前玩法的基数
