...
// 斐波那契数列
{
    var fibonacci = /*#__PURE__*/regeneratorRuntime.mark(function fibonacci() {
        var prev, curr, _ref;

        return regeneratorRuntime.wrap(function fibonacci$(_context3) {
            while (1) {
...
// generator的throw方法
{
    var g = /*#__PURE__*/regeneratorRuntime.mark(function g() {
        return regeneratorRuntime.wrap(function g$(_context4) {
            while (1) {
...
// async babel也可以执行
{
    ...
    var asyncPrint = function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(value, ms) {
            return regeneratorRuntime.wrap(function _callee2$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 2:
                            // 返回一个promise，等待ms后promise执行完毕，再继续执行
                            console.log(value);
...
// async和promise的比较
{
    var takeLongTime = function takeLongTime(n) {
        return new Promise(function (resolve) {
            setTimeout(function () {
                return resolve(n + 200);
            }, n);
        });
    };

    var step1 = function step1(n) {
        console.log('step1 with ' + n);
        return takeLongTime(n);
    };

    var step2 = function step2(n) {
        console.log('step2 with ' + n);
        return takeLongTime(n);
    };

    var step3 = function step3(n) {
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context7) {
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        ...
                        case 4:
                            time2 = _context7.sent;
                            _context7.next = 7;
                            return step2(time2);

                        case 7:
                            time3 = _context7.sent;
                            _context7.next = 10;
                            return step3(time3);
